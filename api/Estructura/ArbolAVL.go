...
func (ar *Arbol) InsertarNodoAVL(valor *Tiendas.Producto) bool {
...
func insertarAVL(ar *Arbol, raiz *NodoAVL, nuevo *NodoAVL) {
	if nuevo.valor.Codigo > raiz.valor.Codigo {
		if raiz.der == nil {
	...
	} else if nuevo.valor.Codigo < raiz.valor.Codigo {
		if raiz.izq == nil {
...
func ObtenerNodo(raiz *NodoAVL, valor *Tiendas.Producto) *NodoAVL {
	if raiz == nil {
		return nil
	} else if raiz.valor.Codigo == valor.Codigo {
...
func (ar *Arbol) Obtener(valor *Tiendas.Producto) *NodoAVL {
...
func inorden(raia *NodoAVL) {
	...
	fmt.Print("nodo: ", raia.valor.Codigo, "    ")
...
func Preorder(raiz *NodoAVL) {
	fmt.Print("nodo: ", raiz.valor.Codigo, "    ")
...
func obtenerPadreAVL(raiz *NodoAVL, valor *Tiendas.Producto) *NodoAVL{
	if valor.Codigo > raiz.valor.Codigo{
		if valor.Codigo == raiz.der.valor.Codigo{
			return raiz
		}else{
		 return	obtenerPadreAVL(raiz.der, valor)
		}
	}else if valor.Codigo < raiz.valor.Codigo {
		if valor.Codigo == raiz.izq.valor.Codigo {
			return raiz
		}else{
